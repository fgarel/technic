...
<qgis version="2.9.0-Master" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="wkb_geometry_3857">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules key="{586f1220-188f-45ce-98fe-f24a5d8ae49a}">
      <rule filter="$id=$atlasfeatureid" key="{dacfdf29-88b3-4bfa-bf41-a14f479d0a1a}" symbol="0" label="CaseCourante"/>
      <rule filter="intersects( $geometry, geometry(  getFeature( 'empriseDeclarationQgis3946','fid' ,'emprise' )))" key="{c4bde459-af35-427d-9090-f336e68b802b}" symbol="1" label="CaseEmprise"/>
      <rule filter=" NOT intersects( $geometry, geometry(  getFeature( 'empriseDeclarationQgis3946','fid' ,'emprise' )))" key="{5b9f63b9-cb1a-44c9-b181-ec9fd7dcee30}" symbol="2" label="CaseHorsEmprise"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="1">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0.002"/>
  ...
  <customproperties>
    ...
    <property key="labeling/bufferSizeMapUnitMaxScale" value="0.0008"/>
