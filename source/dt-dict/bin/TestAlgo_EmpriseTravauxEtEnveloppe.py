...
class Testeur(object):
    ...
    def genereCasesALaVolee(self):
        u"""

        """
        # ici, on pose, en dur un dataframe avec quelques cases
        self.Cases_0040_01400_01000 = pd.DataFrame(
            {'NomCase':
                ['CDA-46-00197-01045-21-A-18',
                 'CDA-46-00197-01045-21-A-19',
                 'CDA-46-00197-01045-21-A-23',
                 'CDA-46-00197-01045-21-A-24',
                 'CDA-46-00197-01045-21-C-03',
                 'CDA-46-00197-01045-21-C-04',
                 'CDA-46-00197-01045-21-C-08',
                 'CDA-46-00197-01045-21-C-09'],
             'XC':
                ['1379350',
                 '1379490',
                 '1379350',
             ...
             'DimY':
                ['100',
                 ...
                 '100'],
             'Geometrie':
                ['MULTIPOLYGON(((1379280 5225600, 1379280 5225700, 1379420 5225700, 1379420 5225600, 1379280 5225600)))',
                 'MULTIPOLYGON(((1379420 5225600, 1379420 5225700, 1379560 5225700, 1379560 5225600, 1379420 5225600)))',
                 'MULTIPOLYGON(((1379280 5225500, 1379280 5225600, 1379420 5225600, 1379420 5225500, 1379280 5225500)))',
                 'MULTIPOLYGON(((1379420 5225500, 1379420 5225600, 1379560 5225600, 1379560 5225500, 1379420 5225500)))',
                 'MULTIPOLYGON(((1379280 5225400, 1379280 5225500, 1379420 5225500, 1379420 5225400, 1379280 5225400)))',
                 'MULTIPOLYGON(((1379420 5225400, 1379420 5225500, 1379560 5225500, 1379560 5225400, 1379420 5225400)))',
                 'MULTIPOLYGON(((1379280 5225300, 1379280 5225400, 1379420 5225400, 1379420 5225300, 1379280 5225300)))',
                 'MULTIPOLYGON(((1379420 5225300, 1379420 5225400, 1379560 5225400, 1379560 5225300, 1379420 5225300)))']})

        self.Cases_0040_01400_01000['Geometrie'] = self.Cases_0040_01400_01000['Geometrie'].apply(wkt.loads)

        self.gCases_0040_01400_01000 = geopandas.GeoDataFrame(self.Cases_0040_01400_01000, geometry='Geometrie')
        print(self.gCases_0040_01400_01000.head())
