...
%\begin{lbdpython}
db = create_engine('postgres://rouqui@localhost/exemples-lbd')
...
for sem in plage:
   q[sem] = select([t.c.date,t.c.temp],
          and_(func.date_trunc('week',t.c.date) > '2005-12-31',func.date_trunc('week',t.c.date) <'2007-01-01',
          extract('week',t.c.date) == sem),order_by=[t.c.date])
   m[sem] = select([func.round(func.avg(t.c.temp),1).label('moy')],
          and_(func.date_trunc('week',t.c.date) > '2005-12-31',func.date_trunc('week',t.c.date) <'2007-01-01',
          extract('week',t.c.date) == sem),group_by=[func.date_trunc('week',t.c.date)])
\end{lbdpython}
