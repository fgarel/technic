...
-- Table: voirie_administratif.numvoie
...
COMMENT ON COLUMN voirie_administratif.numvoie.tex IS 'Numéro';
...
FROM dblink(
   ...
   host=172.17.150.6 user=''frederic.garel'' password=Mie7Asie',
