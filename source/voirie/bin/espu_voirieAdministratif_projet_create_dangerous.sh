...
#echo "psql -h localhost -U fred -d espu -f /home/fred/Documents/technic/source/voirie/bin/sql/espu_voirieAdministratif_projet_create_dangerous.sql"
#      psql -h localhost -U fred -d espu -f /home/fred/Documents/technic/source/voirie/bin/sql/espu_voirieAdministratif_projet_create_dangerous.sql
